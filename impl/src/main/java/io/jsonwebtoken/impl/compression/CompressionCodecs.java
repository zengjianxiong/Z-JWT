 ...
 *
 * @since 0.6.0
 * @deprecated use {@link CompressionCodecs} instead.
 */
@Deprecated
public final class CompressionCodecs {
     ...
     * @deprecated use {@link CompressionCodecs#DEFLATE} instead.
     */
    @Deprecated
    public static final CompressionCodec DEFLATE = CompressionCodecs.DEFLATE;

    /**
     * Codec implementing the <a href="https://en.wikipedia.org/wiki/Gzip">gzip</a> compression algorithm
     * @deprecated use {@link CompressionCodecs#GZIP} instead.
     */
    @Deprecated
    public static final CompressionCodec GZIP = CompressionCodecs.GZIP;
